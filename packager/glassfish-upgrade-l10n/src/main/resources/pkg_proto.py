...
pkg = {
    "name"          : "glassfish-upgrade-l10n",
    "version"       : conf.glassfish_version,
    "attributes"    : {
                        "pkg.summary" : "GlassFish Upgrade Tool Localization",
                        "pkg.description" : "Localization of GlassFish Upgrade Tool (asupgrade) which is a utility to migrate the server configuration, its persisted state, Java EE services, and deployed Java EE applications from a previously installed GlassFish application server to the present GlassFish application server. "+conf.glassfish_description_long,
                        "info.classification" :  conf.glassfish_info_classification,
                      },
    "depends"       : { 
                        "pkg:/glassfish-upgrade@3.1" : {"type" : "require" },
                      },
    "dirtrees"      : [ "glassfish" ],
    "licenses"      : {
